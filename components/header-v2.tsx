        ...
        <div className="flex justify-center h-screen place-items-center max-w-screen">
            <Draggable disabled={!draggable} handle=".handle">
                <div className="w-4/5 bg-white border-8 border-black h-4/5">
                    <div className="flex justify-end w-full h-8 border-b-8 border-black handle bg-amber-200">
                    ...
                    <div className="flex flex-col items-center justify-center h-full p-4 font-mono text-6xl font-medium sm:text-7xl md:text-9xl">
                        <div className="w-fit
